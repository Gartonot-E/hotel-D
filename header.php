...
<header>
    <nav class="navbar">
        <div class="container">
            <a href="/rooms" class="btn">Забронировать</a>
            <ul>
...
<div style="display: none;" id="bookingRoom" class="animated-modal">
    ...
    <div class="info">
        ...
        <div class="row">
            <div class="info__about-room"></div>
            <div class="info__bath"></div>  
        </div> 
        <div class="info__images"></div>
    </div>
    ...
    <form class="main-form" method="POST">
        ...
        <label style>
            ...
            <select name="rooms" id="selectRoom" class="form-control" required>
        ...
        <br>
        <label for="opd" style="font-size: 16px; margin-top: 20px; display: block;">
            <input id="opd" type="checkbox" checked required>
            Согласен с условиями конфиденциальности
        </label>
